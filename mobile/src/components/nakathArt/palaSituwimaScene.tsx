/**
 * පැළ සිටුවීම — bundled illustration PNG, gentle motion on the active hero.
 */
import { useMemo } from 'react';
import { Animated, Image, StyleSheet, View } from 'react-native';
import type { SceneBaseProps } from './scenes';

const PALA_SITUWIMA = require('../../../assets/pala-situwima.png');

export function ScenePalaSituwima({ osc }: SceneBaseProps) {
  ...
  const img = (
    <Image
      source={PALA_SITUWIMA}
      style={styles.img}
      resizeMode="contain"
      accessibilityRole="image"
      accessibilityLabel="පැළ සිටුවීම"
