/**
 * රැකී රක්ෂා සඳහා පිටත්ව යෑම — bundled illustration PNG, gentle motion on the active hero.
 */
import { useMemo } from 'react';
import { Animated, Image, StyleSheet, View } from 'react-native';
import type { SceneBaseProps } from './scenes';

const RAKSHA_PITATA = require('../../../assets/raksha-pitata.png');

export function SceneRakshaPitata({ osc }: SceneBaseProps) {
  ...
  const img = (
    <Image
      source={RAKSHA_PITATA}
      style={styles.img}
      resizeMode="contain"
      accessibilityRole="image"
      accessibilityLabel="රැකී රක්ෂා සඳහා පිටත්ව යෑම"
