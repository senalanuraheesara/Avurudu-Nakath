/**
 * පරණ අවුරුද්ද සඳහා ස්නානය — bundled illustration PNG, gentle motion on the active hero.
 */
import { useMemo } from 'react';
import { Animated, Image, StyleSheet, View } from 'react-native';
import type { SceneBaseProps } from './scenes';

const SNANA_PARANA = require('../../../assets/snana-parana.png');

export function SceneSnana({ osc }: SceneBaseProps) {
  ...
  const img = (
    <Image
      ...
      accessibilityLabel="පරණ අවුරුද්ද සඳහා ස්නානය"
